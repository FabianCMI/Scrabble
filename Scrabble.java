...
public class Scrabble {
	...
	public static void main(String[] args) {
		...
		game.getGameBoard().grid[14][4].setTile(new Tiles('Y', 10));
		game.getGameBoard().grid[14][5].setTile(new Tiles('P', 3));
		game.getGameBoard().grid[14][6].setTile(new Tiles('O', 1));
		game.getGameBoard().grid[14][7].setTile(new Tiles('T', 1));
		game.getGameBoard().grid[14][8].setTile(new Tiles('H', 4));
		game.getGameBoard().grid[14][9].setTile(new Tiles('E', 1));
		game.getGameBoard().grid[14][10].setTile(new Tiles('Q', 8));
		game.getGameBoard().grid[14][11].setTile(new Tiles('U', 1));
